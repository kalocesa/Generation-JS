...
console.log(
  `El resultado de ${valor1} * ${valor2} = ${valor1 * valor2} pesos.`
);
...
//Para los objetos se recomienda usar el métod JSON.stringyfy ( object )
// Convierte un objeto en formato JSON
console.log(JSON.stringify({ name: "Kati", active: true })); // {name:"Kati", active:true}
...
//Conversiòn a tipo Boolean
//En la conversiòn a boolean los siguientes valores son false:
// "", 0, null, undefined
